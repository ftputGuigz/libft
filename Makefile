...
#    Updated: 2020/11/23 11:33:30 by gpetit           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_calloc.c ft_isascii.c ft_itoa.c ft_memmove.c ft_putendl_fd.c ft_split.c \
	ft_strjoin.c ft_strlen.c ft_strnstr.c ft_substr.c ft_atoi.c ft_isalnum.c \
	...
	ft_memcpy.c ft_putchar_fd.c ft_putstr_fd.c ft_strdup.c ft_strlcpy.c ft_strncmp.c \
	ft_strtrim.c ft_toupper.c 

SRCSBONUS = ft_lstadd_back.c ft_lstadd_front.c ft_lstclear.c ft_lstdelone.c ft_lstiter.c \
